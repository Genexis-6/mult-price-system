...
class PriceTrackingWebSocketService {
  ...
  PriceTrackingWebSocketConnectionState _connectionState =
      PriceTrackingWebSocketConnectionState.disconnected;
  PriceTrackingWebSocketConnectionState get connectionState => _connectionState;

  final _stateController =
      StreamController<PriceTrackingWebSocketConnectionState>.broadcast();
  Stream<PriceTrackingWebSocketConnectionState> get onStateChange =>
  ...
  PriceTrackingWebSocketService({required this.email, required this.baseUrl});
  ...
  void _scheduleReconnect() {
    ...
    if (_reconnectAttempts >= _maxReconnectAttempts) {
      logger.w(
        'PriceTrackingWebSocket max reconnect attempts reached, giving up',
      );
      return;
    }
    ...
    _reconnectAttempts++;
    logger.d(
      'PriceTrackingWebSocket scheduling reconnect attempt $_reconnectAttempts in $_reconnectDelay',
    );
